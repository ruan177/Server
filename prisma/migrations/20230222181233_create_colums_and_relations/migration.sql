...
CREATE TABLE `courses` (
    ...
    UNIQUE INDEX `courses_author_id_key`(`author_id`),
...
-- AddForeignKey
ALTER TABLE `courseUsers` ADD CONSTRAINT `courseUsers_course_id_fkey` FOREIGN KEY (`course_id`) REFERENCES `courses`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `courseUsers` ADD CONSTRAINT `courseUsers_user_id_fkey` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
